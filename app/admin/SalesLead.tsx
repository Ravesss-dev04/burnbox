...
export default function SalesLead() {
  ...
  const exportToExcel = () => {
    // Convert leads to CSV and download
    const headers = ['Date', 'Company', 'Contact', 'Email', 'Inquiry', 'Status'];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          ...
          <button
            ...
            className="px-4 py-2 flex items-center gap-2 bg-gradient-to-r from-pink-600 to-purple-600 text-white  rounded-lg hover:pink-500 hover:to-purple-500 transition-all shadow-lg shadow-pink-500/20"
          >
            Export to Excel
          </button>
        </div>
